const az = {
  ...
  avlVendors: {
    title: 'AVL Təchizatçılar',
    new: 'Yeni təchizatçı',
    assessment: 'AVL Qiymətləndirmə',
    assessmentStatus: 'Qiymətləndirmə statusu',
    assessmentDate: 'Qiymətləndirmə tarixi',
    status: { IN_PROGRESS: 'Davam edir', APPROVED: 'Təsdiq edilib', REJECTED: 'Rədd edilib' },
    rejectedReason: 'İmtina səbəbi',
    blacklisted: 'Qara siyahıda',
    blacklistReason: 'Səbəb',
    blacklistedWarning: 'Bu təchizatçı qara siyahıdadır',
    assignVendor: 'Təchizatçı təyin et (AVL)',
    mostRecentShipment: 'Son göndərmə',
    totalShipments: 'Ümumi göndərmələr',
    ogLicense: 'OG Lisenziya',
    insuranceLimit: 'Sığorta limiti',
  },
};
