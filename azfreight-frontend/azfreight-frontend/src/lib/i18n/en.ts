const en = {
  ...
  vehicles: {
    ...
    statuses: { available: 'Available', on_route: 'On Route', maintenance: 'Maintenance', inactive: 'Inactive' },
  },
  drivers: {
    title: 'Drivers',
    new: 'New Driver',
    ...
    notes: 'Notes',
    licenseExpiringSoon: 'License expiring within 30 days',
    licenseExpired: 'License expired',
    noDrivers: 'No drivers added yet',
    statuses: { available: 'Available', on_route: 'On Route', on_leave: 'On Leave', inactive: 'Inactive' },
  },
  fleet: {
  ...
  avlVendors: {
    title: 'AVL Vendors',
    new: 'New Vendor',
    assessment: 'AVL Assessment',
    assessmentStatus: 'Assessment Status',
    assessmentDate: 'Assessment Date',
    status: { IN_PROGRESS: 'In Progress', APPROVED: 'Approved', REJECTED: 'Rejected' },
    rejectedReason: 'Rejection Reason',
    blacklisted: 'Blacklisted',
    blacklistReason: 'Blacklist Reason',
    blacklistedWarning: 'This vendor is blacklisted',
    assignVendor: 'Assign Vendor (AVL)',
    mostRecentShipment: 'Most Recent Shipment',
    totalShipments: 'Total Shipments',
    ogLicense: 'OG License',
